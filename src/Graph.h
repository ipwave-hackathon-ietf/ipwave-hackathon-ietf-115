...
public:
	...
	Graph(int vertexNum, int edge_num, std::vector<int> start,std::vector<int> end, std::vector<double> weight);//Hohyeon
	...
	void set_edge_weight(int start_vertex, int end_vertex, double edge_weight);//hohyeon
...
private:
	...
	void _import_from_data(int vertexNum, int edge_num, std::vector<int> start, std::vector<int> end, std::vector<double> weight);
};
